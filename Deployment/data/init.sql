...
VALUES 
    ...
    (gen_random_uuid(), 'Ana', 'Anić', 'aanic@gmail.com', 'AQAAAAIAAYagAAAAEJlnBPBjrD04lOisfvjs9vB5g/7/z/4lZuADlSKB6QmDTKEIou8LQz8WHOmpEXR5LQ==', '2024-12-12 23:44:58.658571'),
    (gen_random_uuid(), 'Marko', 'Markić', 'mmarkic@gmail.com', 'AQAAAAIAAYagAAAAEJlnBPBjrD04lOisfvjs9vB5g/7/z/4lZuADlSKB6QmDTKEIou8LQz8WHOmpEXR5LQ==', '2024-12-12 23:44:58.658571'),
    (gen_random_uuid(), 'Ivana', 'Ivić', 'iivic@gmail.com', 'AQAAAAIAAYagAAAAEJlnBPBjrD04lOisfvjs9vB5g/7/z/4lZuADlSKB6QmDTKEIou8LQz8WHOmpEXR5LQ==', '2024-12-12 23:44:58.658571');
...
VALUES
    ...
    (gen_random_uuid(), (SELECT "Id" FROM "Models" WHERE "Name" = 'Corolla'), 2018, 5, 'Petrol', 25.0, (SELECT "LocationId" FROM "Locations" WHERE "Adress" = 'Varaždin'), 50000, 'VŽ-123-AB', 'Great condition, low mileage', true, (SELECT "Id" FROM "Users" WHERE "Email"='aanic@gmail.com')),
    (gen_random_uuid(), (SELECT "Id" FROM "Models" WHERE "Name" = 'Golf'), 2015, 5, 'Diesel', 20.0, (SELECT "LocationId" FROM "Locations" WHERE "Adress" = 'Varaždin'), 80000, 'VŽ-456-CD', 'Reliable and fuel-efficient', true, (SELECT "Id" FROM "Users" WHERE "Email"='mmarkic@gmail.com')),
    (gen_random_uuid(), (SELECT "Id" FROM "Models" WHERE "Name" = 'Civic'), 2020, 5, 'Petrol', 30.0, (SELECT "LocationId" FROM "Locations" WHERE "Adress" = 'Varaždin'), 30000, 'VŽ-789-EF', 'Modern design, excellent performance', true, (SELECT "Id" FROM "Users" WHERE "Email"='iivic@gmail.com'));
...
(
    gen_random_uuid(), 
    '0193bd27-e760-7ff0-90eb-3b80f8759259', 
    (SELECT "Id" FROM "Users" WHERE "Email" = 'aanic@gmail.com'),
    '2025-04-10', 
    '2025-04-15', 
    75.0, 
    1, 
...
(
    gen_random_uuid(), 
    '0193bd27-e760-7ff0-90eb-3b80f8759259', 
    (SELECT "Id" FROM "Users" WHERE "Email" = 'mmarkic@gmail.com'),
    '2025-05-20', 
    '2025-05-25', 
    75.0, 
    1, 
...
INSERT INTO "Review" ("UserId", "CarListingId", "Grade", "CreatedAt")
VALUES
(
    (SELECT "Id" FROM "Users" WHERE "Email" = 'iivic@gmail.com'),
    '0193bd27-e760-7ff0-90eb-3b80f8759259',
    4,
    '2025-03-06'
),
